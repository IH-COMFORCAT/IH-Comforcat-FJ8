...
public class SecurityConfig {
    ...
    protected SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((requests) -> requests
                ...
                .requestMatchers(POST, "/api/products/add").hasAnyAuthority("ROLE_USER", "ROLE_ADMIN")
                .requestMatchers(DELETE, "/api/products/delete/**").hasAnyAuthority("ROLE_ADMIN")
                .requestMatchers(GET, "/api/users").hasAnyAuthority("ROLE_USER")
                .requestMatchers(POST, "/api/users").hasAnyAuthority("ROLE_ADMIN")
                .requestMatchers(POST, "/api/users/new").permitAll()
